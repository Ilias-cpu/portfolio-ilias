      ...
      <div className="max-w-5xl w-full mx-auto">
        ...
        >
          ...
          <div className="flex-1 flex flex-col gap-4 pt-1">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              {["Next.js", "Supabase", "Tailwind CSS", "Python", "SQL"].map((o) => <span key={o} style={badgeStyle}>{o}</span>)}
        ...
        >
          ...
          <div className="flex-1 flex flex-col gap-4 pt-1">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              {["Next.js", "Python", "Supabase", "API", "Simulation prédictive", "Données réelles", "SQL"].map((o) => <span key={o} style={badgeStyle}>{o}</span>)}
        ...
        >
          ...
          <div className="flex-1 flex flex-col gap-4 pt-1">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              {["LLM", "n8n", "Make", "Supabase", "API"].map((o) => <span key={o} style={badgeStyle}>{o}</span>)}
              <a
