      ...
      <div className="max-w-5xl w-full mx-auto">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              {["Next.js", "Tailwind CSS", "Supabase", "Python", "SQL", "Pandas", "Numpy", "Matplotlib"].map((o) => <span key={o} style={badgeStyle}>{o}</span>)}
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              {["Next.js", "Python", "Supabase", "SQL", "API", "Simulation prédictive", "Données réelles", "Matplotlib"].map((o) => <span key={o} style={badgeStyle}>{o}</span>)}
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-1">
              {["LLM", "n8n", "Make", "Supabase", "Airtable", "API REST", "SQL", "Python"].map((o) => <span key={o} style={badgeStyle}>{o}</span>)}
              <a
